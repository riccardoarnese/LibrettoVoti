...
public class TestLibretto {
	...
	System.out.format("Il voto %s è %s", giusto.toString(),libr.esisteGiaVoto(giusto));
	
	System.out.format("Il voto %s è %s", sbagliato.toString(),libr.esisteGiaVoto(sbagliato));

	
	System.out.format("Il voto %s è %s", mancante.toString(),libr.esisteGiaVoto(mancante));
